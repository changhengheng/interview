import{_ as e,o as n,c as a,z as t,a as d}from"./chunks/framework.3d6e08ae.js";const g=JSON.parse('{"title":"Vue完整执行流程","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/JingJiang/Vue/源码/Vue完整执行流程、数据代理、数据劫持.md","filePath":"Interview/JingJiang/Vue/源码/Vue完整执行流程、数据代理、数据劫持.md"}'),i={name:"Interview/JingJiang/Vue/源码/Vue完整执行流程、数据代理、数据劫持.md"},o=t("h1",{id:"vue完整执行流程",tabindex:"-1"},[d("Vue完整执行流程 "),t("a",{class:"header-anchor",href:"#vue完整执行流程","aria-label":'Permalink to "Vue完整执行流程"'},"​")],-1),r=t("p",null,"1、new Vue之前就做了很多事情 1-1、主要调用了一个initGlobalAPI(Vue) 给Vue添加了一堆属性和方法供我们之后使用 1-2、又调用了一堆xxxMixin initMixin(Vue) // 添加 Vue.prototype._init() stateMixin(Vue) // 给 Vue.prototype 添加 $set/$delete/$watch方法 eventsMixin(Vue) // 给 Vue.prototype 添加 $on/$once/$emit/$off方法 lifecycleMixin(Vue) // 给 Vue.prototype 添加 $forceUpdate/$destroy/_update方法 renderMixin(Vue) // 给 Vue.prototype 添加 $nextTick/_render方法",-1),u=t("pre",null,[t("code",null,`注意：除了上述两个比较重要的以外，还填了很多东西，只是我们不关注
...
是直接修改的真实dom元素）
`)],-1),m=[o,r,u,s,p,c,_];function l(h,v,f,V,x,w){return n(),a("div",null,m)}const b=e(i,[["render",l]]);export{g as __pageData,b as default};

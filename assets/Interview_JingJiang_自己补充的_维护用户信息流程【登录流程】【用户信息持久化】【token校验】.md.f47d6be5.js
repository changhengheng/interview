import{_ as n,o as e,c as t,O as o}from"./chunks/framework.3d6e08ae.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/JingJiang/自己补充的/维护用户信息流程【登录流程】【用户信息持久化】【token校验】.md","filePath":"Interview/JingJiang/自己补充的/维护用户信息流程【登录流程】【用户信息持久化】【token校验】.md"}'),r={name:"Interview/JingJiang/自己补充的/维护用户信息流程【登录流程】【用户信息持久化】【token校验】.md"},l=o(`<p>userTempId：</p><ul><li>用来区分不同的用户，作为未登录用户的临时身份标识，记录用户的一些数据，比如说添加到购物车的商品</li></ul><p>代码逻辑：</p><ul><li>前提：用户没有登录</li><li>使用uuid生成userTempId</li><li>存储到localStorage（封装一个生成userTempId的方法--&gt;代码逻辑--&gt;- localStorage获取，判断，如果有，就返回。没有就新生成一个，存到localStorage中，再返回。）</li><li>发请求时在请求拦截器里携带到请求头里，添加时和后台商量好</li></ul><p>注册就是一般的流程：</p><ul><li>收集数据</li><li>整理数据</li><li>写API</li><li>发请求</li><li>成功和失败提示</li></ul><p>登录：</p><pre><code>token：
...
</code></pre>`,23),p=[l];function i(_,a,c,k,d,s){return e(),t("div",null,p)}const S=n(r,[["render",i]]);export{g as __pageData,S as default};

import{_ as e,o as t,c as i,k as n,a as o}from"./chunks/framework.e0394e94.js";const J=JSON.parse('{"title":"nginx（自己搭一搭）","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/JingJiang/Vue/项目上线流程.md","filePath":"Interview/JingJiang/Vue/项目上线流程.md","lastUpdated":1689411224000}'),a={name:"Interview/JingJiang/Vue/项目上线流程.md"},s=n("h1",{id:"nginx-自己搭一搭",tabindex:"-1"},[o("nginx（自己搭一搭） "),n("a",{class:"header-anchor",href:"#nginx-自己搭一搭","aria-label":'Permalink to "nginx（自己搭一搭）"'},"​")],-1),r=n("p",null,"项目上线",-1),c=n("pre",null,[n("code",null,`使用 cmd 打开目录，不要运行 exe 文件，运行 exe 后，后台会一直运行线程，刷新重新时需要找到后台运行的服务再清理，太麻烦

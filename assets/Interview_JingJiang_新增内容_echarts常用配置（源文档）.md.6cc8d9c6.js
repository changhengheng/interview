import{_ as s,o as n,c as a,U as l}from"./chunks/framework.e0394e94.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/JingJiang/新增内容/echarts常用配置（源文档）.md","filePath":"Interview/JingJiang/新增内容/echarts常用配置（源文档）.md","lastUpdated":1689411224000}'),p={name:"Interview/JingJiang/新增内容/echarts常用配置（源文档）.md"},e=l(`<h2 id="echarts常用配置" tabindex="-1">echarts常用配置 <a class="header-anchor" href="#echarts常用配置" aria-label="Permalink to &quot;echarts常用配置&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">title: 标题组件</span></span>
